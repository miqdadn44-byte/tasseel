...
const translations = {
  ...
  ar: {
    ...
    'hero.description': 'مجموعة محاماة متخصص يلتزم بتقديم التمثيل القانوني السليم والاستشارات القانونية الدقيقة في مختلف مجالات القانون، وفق أعلى معايير النزاهة والاحتراف، وبفهم عميق للقانون الكويتي.',
    'hero.cta': 'تواصل معنا',
    ...
    'about.description': 'تأسس مجموعة تأصيل للمحاماة عام ٢٠٠٤ بالتزام راسخ بمبادئ العدالة وتقديم التمثيل القانوني السليم. بخبرة تتجاوز عقدين من الزمن، نخدم موكلينا في جميع أنحاء الكويت بمهنية وتفانٍ.',
    'about.mission': 'يعمل مجموعةنا بنزاهة وسرية وفهم عميق للقانون الكويتي. نعمل بجد لحماية حقوق موكلينا ومصالحهم في جميع الشؤون القانونية.',
    ...
    // Footer
    'footer.description': 'مجموعة تأصيل للمحاماة يقدم خدمات قانونية متخصصة بنزاهة والتزام بتحقيق العدالة.',
