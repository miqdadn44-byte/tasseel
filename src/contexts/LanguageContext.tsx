...
const translations = {
  en: {
    ...
    'team.owner1.qualifications.3': '• PhD Researcher in Law — University of Malaya',
    'team.owner1.roles.title': 'Professional Affiliations',
    'team.owner1.roles.1': 'Certified Arbitrator — Kuwait Judges Association Arbitration Center',
    'team.owner1.roles.2': 'Member of the Training Authority — Kuwait Institute for Advocacy and Legal Studies',
    'team.owner1.roles.3': 'Certified Trainer — Kuwait Lawyers Association',
    'team.owner1.roles.4': 'Lecturer and Trainer — Kuwait Institute for Advocacy and Legal Studies',
  ...
  ar: {
    ...
    'hero.description': 'مجموعة محاماة متخصصة تلتزم بتقديم التمثيل القانوني السليم والاستشارات القانونية الدقيقة في مختلف مجالات القانون، وفق أعلى معايير النزاهة والاحتراف، وبفهم عميق للقانون الكويتي.',
    'hero.cta': 'تواصل معنا',
    ...
    // About
    'about.title': 'عن المجموعة',
    'about.description': 'تأسست مجموعة تأصيل للمحاماة عام ٢٠٠٤ بالتزام راسخ بمبادئ العدالة وتقديم التمثيل القانوني السليم. بخبرة تتجاوز عقدين من الزمن، نخدم موكلينا في جميع أنحاء الكويت بمهنية وتفانٍ.',
    'about.mission': 'تعمل مجموعتنا بنزاهة وسرية وفهم عميق للقانون الكويتي. نعمل بجد لحماية حقوق موكلينا ومصالحهم في جميع الشؤون القانونية.',
    ...
    'team.owner1.qualifications.3': '• باحث دكتوراه في القانون — جامعة مالايا',
    'team.owner1.roles.title': 'العضويات المهنية',
    'team.owner1.roles.1': 'محكم معتمد — مركز التحكيم بجمعية القضاة الكويتية',
    'team.owner1.roles.2': 'عضو هيئة التدريب — معهد الكويت للمحاماة والدراسات القانونية',
    'team.owner1.roles.3': 'مدرب معتمد — جمعية المحامين الكويتية',
    'team.owner1.roles.4': 'محاضر ومدرب — معهد الكويت للمحاماة والدراسات القانونية',
    ...
    'contact.location': 'موقع المجموعة',
    'contact.address': 'الفحاحيل، قطعة ٨، شارع ٤٣، مبنى ٧، الطابق الثاني',
    'contact.city': 'الفحاحيل، الكويت',

    // Footer
    'footer.description': 'مجموعة تأصيل للمحاماة تقدم خدمات قانونية متخصصة بنزاهة والتزام بتحقيق العدالة.',
    ...
    // Social
    'footer.social.instagram': 'مجموعة تأصيل للمحاماة على إنستغرام',
    'footer.social.facebook': 'مجموعة تأصيل للمحاماة على فيسبوك',
    'footer.social.linkedin': 'مجموعة تأصيل للمحاماة على لينكد إن',
    'footer.social.twitter': 'مجموعة تأصيل للمحاماة على تويتر',
  },
};
