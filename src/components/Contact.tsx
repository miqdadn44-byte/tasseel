      ...
      <div className="container mx-auto px-6 lg:px-12">
        ...
        <div className="grid lg:grid-cols-2 gap-20 lg:gap-32 max-w-6xl mx-auto items-start">
          ...
          <div className="space-y-16 py-4">
            ...
            {/* Google Maps Embed */}
            <div className="mt-12">
              <div className="rounded-sm overflow-hidden border border-border/60 shadow-lg">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3481.8339!2d48.1189!3d29.1539!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3fcf7b5268341683%3A0x491e39f8c4e6e89c!2sAl-Fahaheel%2C%20Kuwait!5e0!3m2!1sen!2s!4v1234567890"
                  width="100%"
                  height="350"
                  style={{ border: 0 }}
                  allowFullScreen
